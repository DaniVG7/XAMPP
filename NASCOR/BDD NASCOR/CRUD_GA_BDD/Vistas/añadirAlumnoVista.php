...
<form action="añadir2AlumnoControlador.php" method="post">
	...
	<label><strong>Primer Apellido:</strong></label><input type="text" require name="ap1"><br>
	<label><strong>Segundo Apellido:</strong></label><input type="text" require name="ap2"><br>
	<label><strong>DNI:</strong></label><input type="text" require name="DNI"><br>
