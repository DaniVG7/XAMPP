<a href="anadir1PlantaControlador.php">Añadir Planta</a> || 
<!--<a href="../controladores/leerPlantasJSONControlador.php">Ver JSON</a> || 
<a href="../controladores/leerPlantasXMLControlador.php">Ver XML</a>-->
<a href="../controladores/leerPlantasControlador.php?tipo=XML">Versión XML</a> || 
<a href="../controladores/leerPlantasControlador.php?tipo=JSON">Versión JSON</a> ||
<a href="../controladores/leerMarcasControlador.php">Nuestros abonos</a> 
...
foreach ($plantas->plantas as $planta) {
	...
	echo '<a href="leerInfoPlantaControlador.php?idPlanta='.$planta['id'].'"><button>Ver información adicional</button></a>  ';
	echo '<hr>';
}