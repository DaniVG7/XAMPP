...
<form action="añadir2LibroControlador.php" method="post">
	...
	<label><strong>Número de páginas:</strong></label><input type="text" required name="numPaginas"><br>
	<label><strong>Idioma:</strong></label><input type="text" required name="idioma"><br>
	<label><strong>Año de publicación:</strong></label><input type="number" name="añoPublicacion"><br>
	<label><strong>Género literario:</strong></label><input type="text" required name="generoLiterario"><br>
	<label><strong>Premios:</strong></label><input type="text"  name="premios"><br>
	<label><strong>URL imagen portada:</strong></label><input type="text" name="imagen">
...
<select required name="autor[]" >
    ...
    ?>
</select><p>Aviso: si el autor no se encuentra en nuestra lista de autores vaya primero a añadir autor.</p>
	<label><strong>Sinopsis</strong></label><br>
	<textarea name="sinopsis" rows="10" cols="50"></textarea><br><br>
