...
{
$metodo=$_POST['metodo'];
$servicio_url="https://nascor13.md360.es/WebServices/wsrest_plantas2.php";	
     if ($metodo=='DELETE') {
		$id=$_POST['id_planta'];
		$parametros='?id='.$id;
		$ch = curl_init();
...
<form>
  ...
  <select id="plantas">
	<option>- Sekecciona -</option>
<?php

$data = json_decode( file_get_contents('https://nascor13.md360.es/WebServices/wsrest_plantas2.php'), true );
