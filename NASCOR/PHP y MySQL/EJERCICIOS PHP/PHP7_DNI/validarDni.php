...
if (!is_numeric($numeroDNI) || floor($numeroDNI) != $numeroDNI || $numeroDNI < 1 || $numeroDNI > 99999999) { //!is_numeric estamos verificando que lo que introduce sea un numero (equivalente en JS al !IsNaN) y con el floor, que sea un numero entero (equivalente en JS al num.IsInteger pero distinto). Lo que hace floor es redondear un numero decimal, y luego lo comparamos con numeroDni y si es diferente (pq numeroDni será decimal, nos dará el error).
